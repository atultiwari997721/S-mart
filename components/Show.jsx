...
const Show = () => {
    // FIX: Removed the redundant string in the environment variable fallback.
    // The correct syntax for the fallback is: || '₹'
        ...
        <div className='mx-6'>
            <div className='flex flex-row gap-4 max-w-2xl mx-auto my-8'>
                ...
                <div className='flex-1 flex flex-col items-start justify-between bg-blue-200 rounded-2xl p-4 group min-w-[120px]'>
                    ...
                    {/* Assuming assets.hero_product_img2 is a valid image source */}
                    <Image className='w-20 mt-2' src={assets.hero_product_img2} alt="20% discounts sample" />
                </div>
            </div>
            <CategoriesMarquee />
        </div>
